...
func NewStartupProbeParams(containerName string, failureThreshold int32, initialDelaySeconds int32, periodSeconds int32, successThreshold int32, timeoutSeconds int32) *StartupProbeParams {
...
// NewStartupProbeParamsWithDefaults instantiates a new StartupProbeParams object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewStartupProbeParamsWithDefaults() *StartupProbeParams {
	this := StartupProbeParams{}
