...
func NewPreferred(preference NodeSelectorTerm, weight int32) *Preferred {
	this := Preferred{}
...
// NewPreferredWithDefaults instantiates a new Preferred object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPreferredWithDefaults() *Preferred {
	this := Preferred{}
	return &this
}
