...
func NewPodAffinityTerm(topologyKey string) *PodAffinityTerm {
	this := PodAffinityTerm{}
	this.topologyKey = topologyKey
	return &this
}

// NewPodAffinityTermWithDefaults instantiates a new PodAffinityTerm object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPodAffinityTermWithDefaults() *PodAffinityTerm {
	this := PodAffinityTerm{}
	return &this
}
