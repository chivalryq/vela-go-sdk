...
func NewNodeSelecor(key string, operator string) *NodeSelecor {
	this := NodeSelecor{}
	this.key = key
...
// NewNodeSelecorWithDefaults instantiates a new NodeSelecor object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNodeSelecorWithDefaults() *NodeSelecor {
	this := NodeSelecor{}
