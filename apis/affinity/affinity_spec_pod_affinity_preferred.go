...
func NewAffinitySpecPodAffinityPreferred(podAffinityTerm PodAffinityTerm, weight int32) *AffinitySpecPodAffinityPreferred {
...
// NewAffinitySpecPodAffinityPreferredWithDefaults instantiates a new AffinitySpecPodAffinityPreferred object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAffinitySpecPodAffinityPreferredWithDefaults() *AffinitySpecPodAffinityPreferred {
	this := AffinitySpecPodAffinityPreferred{}
	return &this
}
