...
func NewAffinitySpecTolerations(operator string) *AffinitySpecTolerations {
	this := AffinitySpecTolerations{}
	this.operator = operator
	return &this
}

// NewAffinitySpecTolerationsWithDefaults instantiates a new AffinitySpecTolerations object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAffinitySpecTolerationsWithDefaults() *AffinitySpecTolerations {
	this := AffinitySpecTolerations{}
