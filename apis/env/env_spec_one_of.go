...
func NewEnvSpecOneOf(containers []PatchParams) *EnvSpecOneOf {
	this := EnvSpecOneOf{}
	this.containers = containers
	return &this
}

// NewEnvSpecOneOfWithDefaults instantiates a new EnvSpecOneOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEnvSpecOneOfWithDefaults() *EnvSpecOneOf {
	this := EnvSpecOneOf{}
	return &this
}
