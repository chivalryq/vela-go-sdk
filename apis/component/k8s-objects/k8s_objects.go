...
func K8sObjects(name string) *K8sObjectsComponent {
	k := &K8sObjectsComponent{Base: api.ComponentBase{
		Name: name,
	}}
	return k
}
...
func (k *K8sObjectsComponent) Props() *K8sObjectsSpec {
	return &k.Properties
}

func (k *K8sObjectsComponent) AddTrait(traits ...api.Trait) *K8sObjectsComponent {
