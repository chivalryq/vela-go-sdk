...
func RefObjects(name string) *RefObjectsComponent {
	r := &RefObjectsComponent{Base: api.ComponentBase{
		Name: name,
	}}
	return r
}
...
func (r *RefObjectsComponent) Props() *RefObjectsSpec {
	return &r.Properties
}

func (r *RefObjectsComponent) AddTrait(traits ...api.Trait) *RefObjectsComponent {
