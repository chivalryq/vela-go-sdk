...
func Webservice(name string) *WebserviceComponent {
	w := &WebserviceComponent{Base: api.ComponentBase{
		Name: name,
	}}
	return w
}
...
func (w *WebserviceComponent) Props() *WebserviceSpec {
	return &w.Properties
}

func (w *WebserviceComponent) AddTrait(traits ...api.Trait) *WebserviceComponent {
