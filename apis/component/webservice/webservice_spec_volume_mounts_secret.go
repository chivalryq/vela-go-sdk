...
// NewWebserviceSpecVolumeMountsSecretWith instantiates a new WebserviceSpecVolumeMountsSecret object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebserviceSpecVolumeMountsSecretWith(defaultMode int32, mountPath string, name string, secretName string) *WebserviceSpecVolumeMountsSecret {
...
func NewWebserviceSpecVolumeMountsSecret() *WebserviceSpecVolumeMountsSecret {
	this := WebserviceSpecVolumeMountsSecret{}
