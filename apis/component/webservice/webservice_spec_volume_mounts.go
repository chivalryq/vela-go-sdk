...
// NewWebserviceSpecVolumeMountsWith instantiates a new WebserviceSpecVolumeMounts object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebserviceSpecVolumeMountsWith() *WebserviceSpecVolumeMounts {
...
// ConfigMap gets a reference to the given []WebserviceSpecVolumeMountsConfigMap and assigns it to the configMap field.
...
// EmptyDir gets a reference to the given []WebserviceSpecVolumeMountsEmptyDir and assigns it to the emptyDir field.
...
// HostPath gets a reference to the given []WebserviceSpecVolumeMountsHostPath and assigns it to the hostPath field.
...
// Pvc gets a reference to the given []WebserviceSpecVolumeMountsPvc and assigns it to the pvc field.
...
// Secret gets a reference to the given []WebserviceSpecVolumeMountsSecret and assigns it to the secret field.
