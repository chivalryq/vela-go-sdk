...
func NewConfigMapKeyRef(key string, name string) *ConfigMapKeyRef {
...
// NewConfigMapKeyRefWithDefaults instantiates a new ConfigMapKeyRef object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewConfigMapKeyRefWithDefaults() *ConfigMapKeyRef {
	this := ConfigMapKeyRef{}
	return &this
}
