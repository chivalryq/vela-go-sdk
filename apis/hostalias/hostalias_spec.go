...
func NewHostaliasSpec(hostAliases []HostAliases) *HostaliasSpec {
	this := HostaliasSpec{}
	this.hostAliases = hostAliases
	return &this
}

// NewHostaliasSpecWithDefaults instantiates a new HostaliasSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHostaliasSpecWithDefaults() *HostaliasSpec {
	this := HostaliasSpec{}
	return &this
}

// GetHostAliases returns the HostAliases field value
func (o *HostaliasSpec) GetHostAliases() []HostAliases {
	if o == nil {
		var ret []HostAliases
		return ret
	}
...
func (o *HostaliasSpec) GetHostAliasesOk() ([]HostAliases, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostaliasSpec) HostAliases(v []HostAliases) *HostaliasSpec {
	o.hostAliases = v
    return o
}
