...
func NewApplyComponentSpec(cluster string, component string) *ApplyComponentSpec {
...
// NewApplyComponentSpecWithDefaults instantiates a new ApplyComponentSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewApplyComponentSpecWithDefaults() *ApplyComponentSpec {
	this := ApplyComponentSpec{}
	var cluster string = ""
	this.cluster = cluster
	return &this
...
func (o *ApplyComponentSpec) GetCluster() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ApplyComponentSpec) GetClusterOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApplyComponentSpec) Cluster(v string) *ApplyComponentSpec {
	o.cluster = v
    return o
}

// GetComponent returns the Component field value
func (o *ApplyComponentSpec) GetComponent() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApplyComponentSpec) GetComponentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApplyComponentSpec) Component(v string) *ApplyComponentSpec {
	o.component = v
    return o
}
