...
func ApplyOnce() *ApplyOncePolicy {
	a := &ApplyOncePolicy{Base: api.PolicyBase{}}
	return a
}

func (a *ApplyOncePolicy) Build() v1alpha1.Policy {
	res := v1alpha1.Policy{
...
func (a *ApplyOncePolicy) Props() *ApplyOnceSpec {
	return &a.Properties
}
