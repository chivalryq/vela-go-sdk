...
func Replication() *ReplicationPolicy {
	r := &ReplicationPolicy{Base: api.PolicyBase{}}
	return r
}

func (r *ReplicationPolicy) Build() v1alpha1.Policy {
	res := v1alpha1.Policy{
...
func (r *ReplicationPolicy) Props() *ReplicationSpec {
	return &r.Properties
}
