...
func NewCommandSpecOneOf(containers []PatchParams) *CommandSpecOneOf {
	this := CommandSpecOneOf{}
	this.containers = containers
	return &this
}

// NewCommandSpecOneOfWithDefaults instantiates a new CommandSpecOneOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCommandSpecOneOfWithDefaults() *CommandSpecOneOf {
	this := CommandSpecOneOf{}
	return &this
}
...
func (o *CommandSpecOneOf) Containers(v []PatchParams) *CommandSpecOneOf {
	o.containers = v
    return o
}
