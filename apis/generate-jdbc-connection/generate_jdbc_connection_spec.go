...
func NewGenerateJdbcConnectionSpec(name string) *GenerateJdbcConnectionSpec {
	this := GenerateJdbcConnectionSpec{}
	this.name = name
	return &this
}

// NewGenerateJdbcConnectionSpecWithDefaults instantiates a new GenerateJdbcConnectionSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGenerateJdbcConnectionSpecWithDefaults() *GenerateJdbcConnectionSpec {
	this := GenerateJdbcConnectionSpec{}
	return &this
}

// GetName returns the Name field value
func (o *GenerateJdbcConnectionSpec) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GenerateJdbcConnectionSpec) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.name, true
...
func (o *GenerateJdbcConnectionSpec) Name(v string) *GenerateJdbcConnectionSpec {
	o.name = v
    return o
}

// GetNamespace returns the Namespace field value if set, zero value otherwise.
func (o *GenerateJdbcConnectionSpec) GetNamespace() string {
...
// and a boolean to check if the value has been set.
func (o *GenerateJdbcConnectionSpec) GetNamespaceOk() (*string, bool) {
	if o == nil || utils.IsNil(o.namespace) {
		return nil, false
	}
...
func (o *GenerateJdbcConnectionSpec) HasNamespace() bool {
	if o != nil && !utils.IsNil(o.namespace) {
		return true
	}
...
func (o *GenerateJdbcConnectionSpec) Namespace(v string) (*GenerateJdbcConnectionSpec){
	o.namespace = &v
return o
}
