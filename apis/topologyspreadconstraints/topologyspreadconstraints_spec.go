...
func NewTopologyspreadconstraintsSpec(constraints []Constraints) *TopologyspreadconstraintsSpec {
	this := TopologyspreadconstraintsSpec{}
	this.constraints = constraints
	return &this
}

// NewTopologyspreadconstraintsSpecWithDefaults instantiates a new TopologyspreadconstraintsSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTopologyspreadconstraintsSpecWithDefaults() *TopologyspreadconstraintsSpec {
	this := TopologyspreadconstraintsSpec{}
	return &this
}

// GetConstraints returns the Constraints field value
func (o *TopologyspreadconstraintsSpec) GetConstraints() []Constraints {
	if o == nil {
		var ret []Constraints
		return ret
	}
...
func (o *TopologyspreadconstraintsSpec) GetConstraintsOk() ([]Constraints, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TopologyspreadconstraintsSpec) Constraints(v []Constraints) *TopologyspreadconstraintsSpec {
	o.constraints = v
    return o
}
