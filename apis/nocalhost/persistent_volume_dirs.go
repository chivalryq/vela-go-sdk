...
func NewPersistentVolumeDirs(capacity string, path string) *PersistentVolumeDirs {
...
// NewPersistentVolumeDirsWithDefaults instantiates a new PersistentVolumeDirs object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPersistentVolumeDirsWithDefaults() *PersistentVolumeDirs {
	this := PersistentVolumeDirs{}
	return &this
}
