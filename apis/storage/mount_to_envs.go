...
func NewMountToEnvs(configMapKey string, envName string) *MountToEnvs {
	this := MountToEnvs{}
...
// NewMountToEnvsWithDefaults instantiates a new MountToEnvs object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMountToEnvsWithDefaults() *MountToEnvs {
	this := MountToEnvs{}
	return &this
}
...
func (o *MountToEnvs) ConfigMapKey(v string) *MountToEnvs {
	o.configMapKey = v
    return o
}
...
func (o *MountToEnvs) EnvName(v string) *MountToEnvs {
	o.envName = v
    return o
}
