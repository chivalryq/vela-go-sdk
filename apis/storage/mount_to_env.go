...
func NewMountToEnv(configMapKey string, envName string) *MountToEnv {
	this := MountToEnv{}
...
// NewMountToEnvWithDefaults instantiates a new MountToEnv object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMountToEnvWithDefaults() *MountToEnv {
	this := MountToEnv{}
	return &this
}
