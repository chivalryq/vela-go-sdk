...
func NewProviderBasic(accessKey string, region string, secretKey string) *ProviderBasic {
	this := ProviderBasic{}
...
// NewProviderBasicWithDefaults instantiates a new ProviderBasic object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProviderBasicWithDefaults() *ProviderBasic {
	this := ProviderBasic{}
	return &this
}
