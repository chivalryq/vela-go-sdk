...
func NewTencentProvider(name string, region string, secretID string, secretKey string, type_ string) *TencentProvider {
...
// NewTencentProviderWithDefaults instantiates a new TencentProvider object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTencentProviderWithDefaults() *TencentProvider {
	this := TencentProvider{}
