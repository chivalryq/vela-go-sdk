...
func NewUCloudProvider(name string, privateKey string, projectID string, publicKey string, region string, type_ string) *UCloudProvider {
	this := UCloudProvider{}
	this.name = name
...
// NewUCloudProviderWithDefaults instantiates a new UCloudProvider object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUCloudProviderWithDefaults() *UCloudProvider {
	this := UCloudProvider{}
