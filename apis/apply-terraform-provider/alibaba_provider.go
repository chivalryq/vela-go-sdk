...
func NewAlibabaProvider(accessKey string, region string, secretKey string) *AlibabaProvider {
...
// NewAlibabaProviderWithDefaults instantiates a new AlibabaProvider object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAlibabaProviderWithDefaults() *AlibabaProvider {
	this := AlibabaProvider{}
