...
func NewAzureProvider(clientID string, clientSecret string, name string, subscriptionID string, tenantID string) *AzureProvider {
	this := AzureProvider{}
...
// NewAzureProviderWithDefaults instantiates a new AzureProvider object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAzureProviderWithDefaults() *AzureProvider {
	this := AzureProvider{}
