...
func NewECProvider(apiKey string, name Name, type_ string) *ECProvider {
	this := ECProvider{}
	this.apiKey = apiKey
	this.name = name
	this.type_ = type_
...
// NewECProviderWithDefaults instantiates a new ECProvider object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewECProviderWithDefaults() *ECProvider {
	this := ECProvider{}
	var apiKey string = ""
	this.apiKey = apiKey
	return &this
...
func (o *ECProvider) GetName() Name {
	if o == nil {
		var ret Name
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ECProvider) GetNameOk() (*Name, bool) {
	if o == nil {
		return nil, false
	}
	return &o.name, true
...
func (o *ECProvider) Name(v Name) *ECProvider {
	o.name = v
    return o
}
