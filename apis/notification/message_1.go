...
func NewMessage1(content string, msgType string) *Message1 {
	this := Message1{}
...
// NewMessage1WithDefaults instantiates a new Message1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMessage1WithDefaults() *Message1 {
	this := Message1{}
	return &this
}
