...
func NewPasswordOneOf(value string) *PasswordOneOf {
	this := PasswordOneOf{}
	this.value = value
	return &this
}

// NewPasswordOneOfWithDefaults instantiates a new PasswordOneOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPasswordOneOfWithDefaults() *PasswordOneOf {
	this := PasswordOneOf{}
	return &this
}
