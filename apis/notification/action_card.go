...
func NewActionCard(btnOrientation string, btns NullableString, hideAvatar string, singleTitle string, singleURL string, text string, title string) *ActionCard {
	this := ActionCard{}
...
// NewActionCardWithDefaults instantiates a new ActionCard object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActionCardWithDefaults() *ActionCard {
	this := ActionCard{}
	return &this
}
