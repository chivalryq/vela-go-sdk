...
func NewProviderRef(name string, namespace string) *ProviderRef {
	this := ProviderRef{}
	this.name = name
...
// NewProviderRefWithDefaults instantiates a new ProviderRef object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProviderRefWithDefaults() *ProviderRef {
	this := ProviderRef{}
	return &this
}
