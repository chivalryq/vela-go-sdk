...
func NewSourceOneOf1(remote string) *SourceOneOf1 {
	this := SourceOneOf1{}
	this.remote = remote
	return &this
}

// NewSourceOneOf1WithDefaults instantiates a new SourceOneOf1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSourceOneOf1WithDefaults() *SourceOneOf1 {
	this := SourceOneOf1{}
