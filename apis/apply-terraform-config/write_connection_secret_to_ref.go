...
func NewWriteConnectionSecretToRef(name string, namespace string) *WriteConnectionSecretToRef {
...
// NewWriteConnectionSecretToRefWithDefaults instantiates a new WriteConnectionSecretToRef object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWriteConnectionSecretToRefWithDefaults() *WriteConnectionSecretToRef {
	this := WriteConnectionSecretToRef{}
	return &this
}
