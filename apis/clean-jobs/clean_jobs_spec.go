...
func NewCleanJobsSpec(namespace string) *CleanJobsSpec {
	this := CleanJobsSpec{}
	this.namespace = namespace
	return &this
}

// NewCleanJobsSpecWithDefaults instantiates a new CleanJobsSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCleanJobsSpecWithDefaults() *CleanJobsSpec {
	this := CleanJobsSpec{}
	return &this
}

// GetLabelselector returns the Labelselector field value if set, zero value otherwise.
func (o *CleanJobsSpec) GetLabelselector() map[string]interface{} {
...
func (o *CleanJobsSpec) GetLabelselectorOk() (map[string]interface{}, bool) {
	if o == nil || utils.IsNil(o.labelselector) {
...
func (o *CleanJobsSpec) HasLabelselector() bool {
	if o != nil && !utils.IsNil(o.labelselector) {
		return true
	}
...
func (o *CleanJobsSpec) Labelselector(v map[string]interface{}) (*CleanJobsSpec){
	o.labelselector = v
return o
}

// GetNamespace returns the Namespace field value
func (o *CleanJobsSpec) GetNamespace() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CleanJobsSpec) GetNamespaceOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CleanJobsSpec) Namespace(v string) *CleanJobsSpec {
	o.namespace = v
    return o
}
