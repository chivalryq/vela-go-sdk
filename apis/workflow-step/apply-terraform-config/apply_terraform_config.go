...
func ApplyTerraformConfig() *ApplyTerraformConfigWorkflowStep {
	a := &ApplyTerraformConfigWorkflowStep{Base: api.WorkflowStepBase{}}
	return a
}

func (a *ApplyTerraformConfigWorkflowStep) Build() common.WorkflowStep {
...
func (a *ApplyTerraformConfigWorkflowStep) Props() *ApplyTerraformConfigSpec {
	return &a.Properties
}
