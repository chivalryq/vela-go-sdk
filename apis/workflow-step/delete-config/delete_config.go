...
func DeleteConfig() *DeleteConfigWorkflowStep {
	d := &DeleteConfigWorkflowStep{Base: api.WorkflowStepBase{}}
	return d
}

func (d *DeleteConfigWorkflowStep) Build() common.WorkflowStep {
...
func (d *DeleteConfigWorkflowStep) Props() *DeleteConfigSpec {
	return &d.Properties
}
