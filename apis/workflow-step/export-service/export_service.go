...
func ExportService() *ExportServiceWorkflowStep {
	e := &ExportServiceWorkflowStep{Base: api.WorkflowStepBase{}}
	return e
}

func (e *ExportServiceWorkflowStep) Build() common.WorkflowStep {
...
func (e *ExportServiceWorkflowStep) Props() *ExportServiceSpec {
	return &e.Properties
}
