...
func BuildPushImage() *BuildPushImageWorkflowStep {
	b := &BuildPushImageWorkflowStep{Base: api.WorkflowStepBase{}}
	return b
}

func (b *BuildPushImageWorkflowStep) Build() common.WorkflowStep {
...
func (b *BuildPushImageWorkflowStep) Props() *BuildPushImageSpec {
	return &b.Properties
}
