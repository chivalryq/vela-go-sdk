...
func ReadObject() *ReadObjectWorkflowStep {
	r := &ReadObjectWorkflowStep{Base: api.WorkflowStepBase{}}
	return r
}

func (r *ReadObjectWorkflowStep) Build() common.WorkflowStep {
...
func (r *ReadObjectWorkflowStep) Props() *ReadObjectSpec {
	return &r.Properties
}
