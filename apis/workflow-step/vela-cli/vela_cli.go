...
func VelaCli() *VelaCliWorkflowStep {
	v := &VelaCliWorkflowStep{Base: api.WorkflowStepBase{}}
	return v
}

func (v *VelaCliWorkflowStep) Build() common.WorkflowStep {
...
func (v *VelaCliWorkflowStep) Props() *VelaCliSpec {
	return &v.Properties
}
