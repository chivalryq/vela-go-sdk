...
func CreateConfig() *CreateConfigWorkflowStep {
	c := &CreateConfigWorkflowStep{Base: api.WorkflowStepBase{}}
	return c
}

func (c *CreateConfigWorkflowStep) Build() common.WorkflowStep {
...
func (c *CreateConfigWorkflowStep) Props() *CreateConfigSpec {
	return &c.Properties
}
