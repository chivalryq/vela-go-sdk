...
func ApplyTerraformProvider() *ApplyTerraformProviderWorkflowStep {
	a := &ApplyTerraformProviderWorkflowStep{Base: api.WorkflowStepBase{}}
	return a
}

func (a *ApplyTerraformProviderWorkflowStep) Build() common.WorkflowStep {
...
func (a *ApplyTerraformProviderWorkflowStep) Props() *ApplyTerraformProviderSpec {
	return &a.Properties
}
