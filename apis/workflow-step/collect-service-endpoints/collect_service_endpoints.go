...
func CollectServiceEndpoints() *CollectServiceEndpointsWorkflowStep {
	c := &CollectServiceEndpointsWorkflowStep{Base: api.WorkflowStepBase{}}
	return c
}

func (c *CollectServiceEndpointsWorkflowStep) Build() common.WorkflowStep {
...
func (c *CollectServiceEndpointsWorkflowStep) Props() *CollectServiceEndpointsSpec {
	return &c.Properties
}
