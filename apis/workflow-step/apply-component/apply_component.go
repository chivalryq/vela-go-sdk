...
func ApplyComponent() *ApplyComponentWorkflowStep {
	a := &ApplyComponentWorkflowStep{Base: api.WorkflowStepBase{}}
	return a
}

func (a *ApplyComponentWorkflowStep) Build() common.WorkflowStep {
...
func (a *ApplyComponentWorkflowStep) Props() *ApplyComponentSpec {
	return &a.Properties
}
