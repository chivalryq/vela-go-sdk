...
func ExportData() *ExportDataWorkflowStep {
	e := &ExportDataWorkflowStep{Base: api.WorkflowStepBase{}}
	return e
}

func (e *ExportDataWorkflowStep) Build() common.WorkflowStep {
...
func (e *ExportDataWorkflowStep) Props() *ExportDataSpec {
	return &e.Properties
}
