...
func Notification() *NotificationWorkflowStep {
	n := &NotificationWorkflowStep{Base: api.WorkflowStepBase{}}
	return n
}

func (n *NotificationWorkflowStep) Build() common.WorkflowStep {
...
func (n *NotificationWorkflowStep) Props() *NotificationSpec {
	return &n.Properties
}
