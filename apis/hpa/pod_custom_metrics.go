...
func NewPodCustomMetrics(name string, value string) *PodCustomMetrics {
...
// NewPodCustomMetricsWithDefaults instantiates a new PodCustomMetrics object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPodCustomMetricsWithDefaults() *PodCustomMetrics {
	this := PodCustomMetrics{}
	return &this
}
