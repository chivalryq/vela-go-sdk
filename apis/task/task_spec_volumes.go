...
func NewTaskSpecVolumes(medium string, mountPath string, name string, type_ string) *TaskSpecVolumes {
...
// NewTaskSpecVolumesWithDefaults instantiates a new TaskSpecVolumes object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTaskSpecVolumesWithDefaults() *TaskSpecVolumes {
	this := TaskSpecVolumes{}
	var medium string = ""
	this.medium = medium
