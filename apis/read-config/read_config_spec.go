...
func NewReadConfigSpec(name string) *ReadConfigSpec {
	this := ReadConfigSpec{}
	this.name = name
	return &this
}

// NewReadConfigSpecWithDefaults instantiates a new ReadConfigSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewReadConfigSpecWithDefaults() *ReadConfigSpec {
	this := ReadConfigSpec{}
	return &this
}

// GetName returns the Name field value
func (o *ReadConfigSpec) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ReadConfigSpec) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.name, true
...
func (o *ReadConfigSpec) Name(v string) *ReadConfigSpec {
	o.name = v
    return o
}

// GetNamespace returns the Namespace field value if set, zero value otherwise.
func (o *ReadConfigSpec) GetNamespace() string {
...
// and a boolean to check if the value has been set.
func (o *ReadConfigSpec) GetNamespaceOk() (*string, bool) {
	if o == nil || utils.IsNil(o.namespace) {
		return nil, false
	}
...
func (o *ReadConfigSpec) HasNamespace() bool {
	if o != nil && !utils.IsNil(o.namespace) {
		return true
	}
...
func (o *ReadConfigSpec) Namespace(v string) (*ReadConfigSpec){
	o.namespace = &v
return o
}
