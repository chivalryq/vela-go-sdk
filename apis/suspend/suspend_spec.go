...
// NewSuspendSpecWithDefaults instantiates a new SuspendSpec object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSuspendSpecWithDefaults() *SuspendSpec {
	this := SuspendSpec{}
	return &this
}

// GetDuration returns the Duration field value if set, zero value otherwise.
func (o *SuspendSpec) GetDuration() string {
...
func (o *SuspendSpec) GetDurationOk() (*string, bool) {
	if o == nil || utils.IsNil(o.duration) {
		return nil, false
	}
...
func (o *SuspendSpec) HasDuration() bool {
	if o != nil && !utils.IsNil(o.duration) {
		return true
	}
...
func (o *SuspendSpec) Duration(v string) (*SuspendSpec){
	o.duration = &v
return o
}
