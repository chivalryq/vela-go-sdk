...
func NewSecretKeyRef(key string, name string) *SecretKeyRef {
	this := SecretKeyRef{}
	this.key = key
	this.name = name
	return &this
...
// NewSecretKeyRefWithDefaults instantiates a new SecretKeyRef object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSecretKeyRefWithDefaults() *SecretKeyRef {
	this := SecretKeyRef{}
	return &this
}
