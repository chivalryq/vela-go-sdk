...
func NewImportGrafanaDashboardSpecWith() *ImportGrafanaDashboardSpec {
...
// NewImportGrafanaDashboardSpec instantiates a new ImportGrafanaDashboardSpec object
...
func NewImportGrafanaDashboardSpecs(ps ...*ImportGrafanaDashboardSpec) []ImportGrafanaDashboardSpec {
...
func (o *ImportGrafanaDashboardWorkflowStep) HasGrafana() bool {
	if o != nil && !utils.IsNil(o.Properties.Grafana) {
		return true
	}
