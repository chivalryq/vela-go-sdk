...
func (a *ApplyTerraformProviderWorkflowStep) Build() v1beta1.WorkflowStep {
...
func (a *ApplyTerraformProviderWorkflowStep) Inputs(input common.StepInputs) *ApplyTerraformProviderWorkflowStep {
	a.Base.Inputs = input
	return a
}
