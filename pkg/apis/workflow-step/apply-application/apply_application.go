...
func init() {
	sdkcommon.RegisterWorkflowStep(ApplyApplicationType, FromWorkflowStep)
	sdkcommon.RegisterWorkflowSubStep(ApplyApplicationType, FromWorkflowSubStep)
}
...
func (a *ApplyApplicationWorkflowStep) FromWorkflowStep(from v1beta1.WorkflowStep) (*ApplyApplicationWorkflowStep, error) {
	var properties ApplyApplicationSpec
...
func (a *ApplyApplicationWorkflowStep) FromWorkflowSubStep(from common.WorkflowSubStep) (*ApplyApplicationWorkflowStep, error) {
	var properties ApplyApplicationSpec
	if from.Properties != nil {
		err := json.Unmarshal(from.Properties.Raw, &properties)
		if err != nil {
