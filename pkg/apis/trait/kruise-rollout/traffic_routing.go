...
func NewTrafficRoutingWith() *TrafficRouting {
	this := TrafficRouting{}
...
// NewTrafficRouting instantiates a new TrafficRouting object
...
func NewTrafficRoutings(ps ...*TrafficRouting) []TrafficRouting {
	objs := []TrafficRouting{}
	for _, p := range ps {
		objs = append(objs, *p)
	}
...
func (o *TrafficRouting) GetGracePeriodSeconds() int32 {
	if o == nil || utils.IsNil(o.GracePeriodSeconds) {
		var ret int32
		return ret
	}
...
func (o *TrafficRouting) HasGracePeriodSeconds() bool {
	if o != nil && !utils.IsNil(o.GracePeriodSeconds) {
		return true
	}
...
func (o *TrafficRouting) HasType() bool {
	if o != nil && !utils.IsNil(o.Type) {
		return true
	}
...
// Type:  specify the type of traffic route, can be ingress or gateway.
...
func (o TrafficRouting) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.GracePeriodSeconds) {
