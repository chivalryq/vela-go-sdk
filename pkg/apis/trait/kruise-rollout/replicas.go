...
// int32AsReplicas is a convenience function that returns int32 wrapped in Replicas
...
// stringAsReplicas is a convenience function that returns string wrapped in Replicas
