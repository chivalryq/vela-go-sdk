...
func (o *Rules) GetGatewayPort() int32 {
	if o == nil || utils.IsNil(o.GatewayPort) {
		var ret int32
		return ret
	}
...
func (o *Rules) HasGatewayPort() bool {
	if o != nil && !utils.IsNil(o.GatewayPort) {
		return true
	}
...
// SetGatewayPort gets a reference to the given int32 and assigns it to the gatewayPort field.
// GatewayPort:  Specify the gateway listener port
