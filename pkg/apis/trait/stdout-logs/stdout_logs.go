...
func NewStdoutLogsSpecWith() *StdoutLogsSpec {
	this := StdoutLogsSpec{}
...
// NewStdoutLogsSpec instantiates a new StdoutLogsSpec object
...
func NewStdoutLogsSpecs(ps ...*StdoutLogsSpec) []StdoutLogsSpec {
	objs := []StdoutLogsSpec{}
	for _, p := range ps {
		objs = append(objs, *p)
	}
...
func (o *StdoutLogsTrait) HasGrafana() bool {
	if o != nil && !utils.IsNil(o.Properties.Grafana) {
		return true
	}
...
// GetLokiEndpoint returns the LokiEndpoint field value if set, zero value otherwise.
func (o *StdoutLogsTrait) GetLokiEndpoint() string {
	if o == nil || utils.IsNil(o.Properties.LokiEndpoint) {
		var ret string
		return ret
	}
...
// GetLokiEndpointOk returns a tuple with the LokiEndpoint field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasLokiEndpoint returns a boolean if a field has been set.
func (o *StdoutLogsTrait) HasLokiEndpoint() bool {
	if o != nil && !utils.IsNil(o.Properties.LokiEndpoint) {
		return true
	}
...
// SetLokiEndpoint gets a reference to the given string and assigns it to the lokiEndpoint field.
// LokiEndpoint:
