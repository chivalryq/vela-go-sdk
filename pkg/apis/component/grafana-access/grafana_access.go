...
func NewGrafanaAccessSpecWith() *GrafanaAccessSpec {
	this := GrafanaAccessSpec{}
	return &this
}

// NewGrafanaAccessSpec instantiates a new GrafanaAccessSpec object
...
func NewGrafanaAccessSpecs(ps ...*GrafanaAccessSpec) []GrafanaAccessSpec {
...
func (o *GrafanaAccessComponent) GetEndpoint() string {
	if o == nil || utils.IsNil(o.Properties.Endpoint) {
		var ret string
		return ret
	}
...
func (o *GrafanaAccessComponent) HasEndpoint() bool {
	if o != nil && !utils.IsNil(o.Properties.Endpoint) {
		return true
	}
...
func (o *GrafanaAccessComponent) HasName() bool {
	if o != nil && !utils.IsNil(o.Properties.Name) {
		return true
	}
...
func (g *GrafanaAccessComponent) AddTrait(traits ...apis.Trait) *GrafanaAccessComponent {
	g.Base.Traits = append(g.Base.Traits, traits...)
	return g
}

func (g *GrafanaAccessComponent) GetTrait(_type string) apis.Trait {
